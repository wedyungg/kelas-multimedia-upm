...
const Onboarding = () => {
  ...
  return (
    <div className="container animate-fade-in" style={{ maxWidth: '600px', padding: '4rem 2rem' }}>
      <div className="card text-center" style={{ padding: '3rem 2rem' }}>
        ...
        <form onSubmit={handleStart} className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4" style={{ textAlign: 'left' }}>
            <label className="text-sm font-medium">Pilih Track (Bisa lebih dari satu)</label>
